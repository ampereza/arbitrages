...
exports.SUPPORTED_BASE_TOKENS = void 0;
exports.isTokenSupported = isTokenSupported;
exports.hasSufficientLiquidity = hasSufficientLiquidity;
exports.getTokenBySymbol = getTokenBySymbol;
exports.hasSupportedTokenInPair = hasSupportedTokenInPair;
exports.SUPPORTED_BASE_TOKENS = [
...
function isTokenSupported(tokenSymbol) {
    return exports.SUPPORTED_BASE_TOKENS.some(token => token.symbol === tokenSymbol);
}
function hasSufficientLiquidity(token) {
    const baseToken = exports.SUPPORTED_BASE_TOKENS.find(t => t.symbol === token.symbol);
...
function getTokenBySymbol(symbol) {
    return exports.SUPPORTED_BASE_TOKENS.find(token => token.symbol === symbol);
}
// Check if at least one token in a pair is supported by Aave (for flash loans)
function hasSupportedTokenInPair(token1Symbol, token2Symbol) {
